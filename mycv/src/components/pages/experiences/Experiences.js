...
class Experiences extends React.Component {
  ...
  componentDidMount() {
    fetch("http://ec2-34-219-153-254.us-west-2.compute.amazonaws.com:18083/api/v1/job_profile/candidate_id_comp/1")
      .then(res => res.json())
                ...
                <div className="row mt-top">
                  ...
                  <div className="col xl8 l8 m6 s12">
                    <blockquote className="no-pad">
                      ...
                      {String(xp.job_duties).replaceAll(',', '').split(".").map(duty => duty && duty !== ' ' ? <ul><i class="fas fa-dot-circle"></i> {duty}.</ul> : '')}
